...
import static com.vikisoft.externallondrishops.utils.SessionManager.LIGHT_THEME;

public class TransacationListAdapter extends RecyclerView.Adapter<TransacationListAdapter.MyViewHolder> {

    private List<String> transactionList;
    private Context context;
    private com.vikisoft.externallondrishops.utils.SessionManager sessionManager;
